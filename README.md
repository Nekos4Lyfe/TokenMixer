...
The purpose of TokenMixer is to bridge the gap between language and vector. You can input very simple words into the TokenMixer to get unique yet semi-deterministic output. Essentially, it is an embedding creation tool without the need to input any training images or do any training. 
