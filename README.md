...
This extension is still an early-access version. Bug reports are welcome. Informal discussions about the TokenMixer can be found here (You will need to navigate to the "extensions" Discord tab to find the "TokenMixer" section): https://discord.gg/NFUmXn4W
